...
function verificarRedirecionamentoPagamento() { // Corrigido o nome da função
...
document.getElementById('form-login').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const res = await fetch(`${baseUrl}/login`, { // Modificado para usar baseUrl
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      credentials: 'include', // Adicionado para incluir cookies de sessão, se necessário
